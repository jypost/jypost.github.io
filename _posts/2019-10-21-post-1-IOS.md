...
- X-code Version 10.2.1 기준 / admob 2019.12.3일 기준
  ∙ luanchScreen.storyboard에 strings파일이 생성이 되어서,<br> 다국어 지원이 가능한 줄 알았는데.<br>
  다해봐도 안돼서 구글링 해보니, 지원 안된다고... 파일생성 안되게 하면 삽질 안했을텐데..<br>
  암튼 정리하면, Splash 다국어 지원 하려면, strings파일로 하면 안되고, 다른 방법 (스토리 보드 별도로 생성)으로 해야함
<br><br>
  참고 : https://stackoverflow.com/questions/30079257/how-to-localize-launch-screen?noredirect=1&lq=1
