...
## <span style="color:#646767; margin-left: 1rem; line-height: 1.8rem; padding-top: 0.2rem;"> ∙ 프로젝트에 admob 등록</span>
이미 생성된 admob id로 진행함\n
<img src="https://github.com/jypost/jypost.github.io/blob/master/img/admob_app_set_01.png?raw=true" width="300" height="300"><br>
프로젝트  생성한 워크스페이스를 열로 App delegate 
폴프로젝트  생성한 워크스페이스를 열로 App delegate 
 생성한 워크스페이스를 열로 App delegate 

---

<hr style="border-top:1px solid #9C9C9C; border-bottom:1px solid #F6F6F6;" />

## <span style="color:#646767; margin-left: 1rem; line-height: 1.8rem; padding-top: 0.2rem;"> ∙ 앱관리</span>
